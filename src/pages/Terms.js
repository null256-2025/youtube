          ...
          <div className="card mb-4">
            <div className="card-body">
              ...
              <div className="alert alert-info">
                ...
                <ul className="mb-0">
                  <li><a href="https://www.youtube.com/t/terms" target="_blank" rel="noopener noreferrer">YouTube利用規約（YouTube Terms of Service）</a></li>
                  <li><a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer">Googleプライバシーポリシー</a></li>
                  <li><a href="https://developers.google.com/youtube/terms/api-services-terms-of-service" target="_blank" rel="noopener noreferrer">YouTube API利用規約</a></li>
                </ul>
              </div>
            </div>
          </div>
